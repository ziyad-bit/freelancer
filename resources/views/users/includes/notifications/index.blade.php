    ...
    @foreach ($user_notifs as $notification)
            ...
            <a class="list-group-item list-group-item-action notif_hover">
                <form action="{{ route('chat-room.add_user') }}" method="POST">
                    ...
                    <div class="d-flex w-100 justify-content-between">
                        <img src="{{ asset('storage/images/users/' . $notification->data['sender_image']) }}" class="rounded-circle"
                            alt="error">
                        <h5 class="mb-1 p">
        ...
        @else
            <div class="list-group notifications" data-created_at="{{ $notification->created_at }}">
                ...
                <a href="{{ route('chat-rooms.index', $notification->notifiable_id) }}" class="list-group-item list-group-item-action notif_hover">
                    <div class="d-flex w-100 justify-content-between">
