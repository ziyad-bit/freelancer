...
class MessageRepository implements MessageRepositoryInterface
{
	...
	####################################   getMessages   #####################################
	public function getMessages(int $receiver_id = null, int $chat_room_id = null):array
	{
		...
		if ($chat_room_id === null && $receiver_id !== null) {
		...
		} elseif ($chat_room_id !== null && $receiver_id === null) {
			...
			$selected_chat_room = DB::table('messages')
				...
				->where(['messages.chat_room_id' => $chat_room_id,'last' => 1])
				->groupBy('messages.id');
